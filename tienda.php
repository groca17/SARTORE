        ...
        <div class="header-wrap">
            ...
            <nav class="nav-header">
                <ul class="main-menu">
                    ...
                    <li class="menu-item"><a href="tienda.php">Tienda</a></li> <!-- Cambié de .html a .php -->
                    <li class="menu-item"><a href="contacto.html">Contacto</a></li>
                    <li class="menu-item"><a href="carrito.php" class="disabled" id="btn-pagar">Ir a pagar</a></li>
                </ul>
            </nav>
        </div>
    </header>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class='producto'>
                            <div class='image-gallery'>
                                <div class='image-item' style='background-image: url(images/" . $row['imagen'] . ");'></div>
                            </div>
                            <h3>" . $row['nombre'] . "</h3>
                            <p>Precio: <strong>$" . $row['precio'] . "</strong></p>
                            <p>Ingredientes: " . $row['descripcion'] . "</p>
